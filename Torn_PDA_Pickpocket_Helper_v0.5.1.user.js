// ==UserScript==
// @name         Torn PDA Pickpocket Helper v0.5.1
// @namespace    torn-pda-local
// @version      0.5.1
// @description  One-tap pick helper that automatically closes the result and prepares the next target
...
(function () {
    ...
    function onPickpocketPage() {
        return location.href.includes('#/pickpocketing');
    }
